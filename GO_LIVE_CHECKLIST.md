...
- [x] **⚠ M3 — Portal magic link**: Done 2026-07-05 — in production `/portal/auth` emails the link via SendGrid and never returns the token; set `SENDGRID_API_KEY` or the endpoint returns 503.
