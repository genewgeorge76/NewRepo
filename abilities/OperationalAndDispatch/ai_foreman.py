...
from abilities.OperationalAndDispatch.foreman_ai_client import ForemanAIClient
...
class AIForeman:
    ...
    def evaluate_telematics(self, telematics_snapshot: dict) -> dict:
        """
        Evaluates a live snapshot of fleet and crew telematics.
        Returns a dispatch assessment and automated command if necessary.
        """
        issues = []
        commands = []
